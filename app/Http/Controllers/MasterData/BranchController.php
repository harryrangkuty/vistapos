...
class BranchController extends AuthController
{
    public function __invoke(Request $request)
    {
        ...
        $vue = "<branch-page :title='" . json_encode($title) . "' :constant='" . json_encode($constant) . "' />";
    ...
    public function read(Request $request)
    {
        if ($request->req == 'table') {
            $data = Branch::where(function ($q) use ($request) {
    ...
    public function write(Request $request)
    {
        ...
        //     $data = Branch::find($request->id) ?? new Branch();
        ...
        //     $data = Branch::onlyTrashed()->find($request->id);
