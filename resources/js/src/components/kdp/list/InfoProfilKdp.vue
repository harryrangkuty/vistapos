...
<template>
    <a-row type="flex" justify="left" :gutter="25">
        <!-- Kolom 1 -->
        <a-col :span="24" :lg="12" class="!flex flex-col">
            ...
            <div class="!w-full shadow-md rounded-[8px] overflow-hidden flex-grow lg:mb-2 mb-6">
                <div class="bg-[#77828c] text-white text-lg px-6 py-2 font-medium">
                    Info Perolehan
                </div>
                <a-card class="card card-white !px-5 h-full">
        ...
        <a-col :span="24" :lg="12" class="!flex flex-col">
            ...
            <div class="!w-full shadow-md rounded-[8px] overflow-hidden flex-grow mb-2">
                <div class="bg-[#77828c] text-white text-lg px-6 py-2 font-medium">
                    Buku Aset
                </div>
                <a-card class="card card-white !px-5 h-full">
