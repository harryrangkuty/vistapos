...
<template>
    <a-row type="flex" justify="center">
        <a-col :span="24">
            <a-card class="card" :title="'Persediaan - Mutasi - ' + parent.kode">
                <a-row type="flex" justify="left">
                    <a-col :span="12">
                        <a-form ref="form" name="info" class="detail-parent" :label-col="{ span: 6 }"
                            ...
                            <a-form-item label="Gudang Asal">
                                <strong>{{ parent.gudang_asal.nama }}</strong>
                            </a-form-item>
                            <a-form-item label="Gudang Tujuan">
                                <strong>{{ parent.gudang_tujuan.nama }}</strong>
                            </a-form-item>
                        </a-form>
                    </a-col>
                    <a-col :span="12">
                ...
                <a-card>
                    ...
                    <a-table :scroll="{ x: 800 }" :columns="columns" :row-key="(obj) => obj.id" :pagination="false"
                        :loading="loadingStatus" :data-source="models">
